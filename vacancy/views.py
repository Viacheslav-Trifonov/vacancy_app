...
def company_start_view(request: WSGIRequest) -> HttpResponse:
    try:
...
def resume_start_view(request: WSGIRequest) -> HttpResponse:
...
def custom_handler404(request: WSGIRequest, exception) -> HttpResponse:
    return render(request, 'vacancy/404.html', status=404)
